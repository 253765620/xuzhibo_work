# coding: utf-8
"""
- CAN回放脚本，实际上是更改的python-can的脚本
- 使用的时候需要更改/usr/local/opt/python-3.7.0/lib/python3.7/site-packages/can/io/csv.py
- 106行左右, CAN数据转码方式更改, data=bytearray.fromhex(data)
"""
