...
class Split_msg_to_str:
    ...
    def split_con(self):
        ...
        while self.con[num] != 23:
            if self.con[num] == 3:
                con_appear['3'] = split_msg_to_str.int_list_to_hex_str(self.con[num+1:num+21])
                num = num+21
            ...
            if self.con[num] == 4:
                ...
                for i in range(num2):
                    ...
                    num = num+12
                con_appear['4'] = self.con_res
                print '4:',con_appear['4']
            if self.con[num] == 5:
                num3 = 19+int(self.con[num+8])
                con_appear['5'] = split_msg_to_str.int_list_to_hex_str(self.con[num+1:num+num3])
                num = num+num3
                print '5:',con_appear['5']
            if self.con[num] == 6:
                con_appear['6'] = split_msg_to_str.int_list_to_hex_str(self.con[num+1:num+6])
                num = num+6
                print '6:',con_appear['6']
            if self.con[num] == 7:
                con_appear['7'] = split_msg_to_str.int_list_to_hex_str(self.con[num+1:num+10])
                num = num+10
                print '7:',con_appear['7']
            if self.con[num] == 8:
                con_appear['8'] = split_msg_to_str.int_list_to_hex_str(self.con[num+1:num+15])
                num = num+15
