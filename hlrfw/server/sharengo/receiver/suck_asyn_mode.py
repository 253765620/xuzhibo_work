...
sys.path.append("/home/pi/hlrfw/server/sharengo")
import asyncore
import socket
import signal
import Queue
...
from configs.ip_config import IP_SERVER_SHARENGO,PORT_SHARENGO,IP


#global parameter
mysock = []
mysock_flag = True
#f = open('/home/pi/Desktop/TTT/err_data_sharengo.txt', 'a')
...
def server_to_ter_msg(q): 
    ...
    mysock2.bind(IP_SERVER_SHARENGO)
    mysock2.listen(5)
    while 1:
        try:
    ...
    def handle_read(self):
        ...
        if data:       
            try:
                ...
                #global f
                print e
                #f.write('sharengo:'+str(time.time())+'\n'+str(e))
...
if __name__ == '__main__':
    server = EchoServer(IP, PORT_SHARENGO)
