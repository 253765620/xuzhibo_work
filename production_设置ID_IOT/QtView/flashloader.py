...
key_status_dict = {
    ...
    '按键和LED': {'开始测试': [False, True, False, '按下按钮1', 'background-color: rgb(255, 255, 0)', '查看信息提示结果', 'background-color: rgb(255, 255, 0)', None],
            '按键1LED1测试通过': [False, True, True, '按键1LED1PASS', 'background-color: rgb(0, 255, 0)', '请按下按键2点击确认LED', None, None],
            '按键1LED1测试失败': [True, True, True, '按键1LED1Fail', 'background-color: rgb(255, 0, 0)', '按键测试失败', None, None],
            '按键2LED2测试通过': [False, True, True, '按键2LED2PASS', 'background-color: rgb(0, 255, 0)', '请按下按键3点击确认LED', None, None],
            '按键2LED2测试失败': [True, True, True, '按键2LED2Fail', 'background-color: rgb(255, 0, 0)', '按键测试失败', None, None],
            '按键3LED3测试通过': [False, True, True, '按键3LED3PASS', 'background-color: rgb(0, 255, 0)', '请按下按键4点击确认LED', None, None],
            '按键3LED3测试失败': [True, True, True, '按键3LED3Fail', 'background-color: rgb(255, 0, 0)', '按键测试失败', None, None],
            '按键4LED4测试通过': [True, False, True, 'PASS', 'background-color: rgb(0, 255, 0)', '测试结束', None, None],
    ...
    'GPIO':{ '开始测试': [False, True, False, '开始测试GPIO', 'background-color: rgb(255, 255, 0)', '查看信息提示结果', 'background-color: rgb(255, 255, 0)', None],
              '测试通过': [True, False, True, 'GPIO测试PASS', 'background-color: rgb(0, 255, 0)', 'GPIO测试结束', None, None],
        ...
        if test_type == '主板：ECM&以太网&按键&LED':
            ...
            if led_t==0:
                ...
                if relay == 0:
                    ...
                    if btn_res==0:
                        power = self.test_ctrl.power_test()
                        if power==0:
                            n1 = self.test_ctrl.gpio_test() 
                            if n1 == 0:
                                #sleep(5)
                                n2 = self.test_ctrl.acce_test()
                                if n2 == 0:
...
class UIFlashloader(QWidget):
    def __init__(self, parent=None):
        ...
        self.testType.addItems([ 'AI-box自检测试-序列号设置','整机功能测试', '主板功能测试','质检测试' ])
